...
export default function BlogGrid({  }: { posts: Post[] }) {
  return (
    <section className="relative overflow-x-clip py-12 sm:py-20 md:py-24 lg:py-28 bg-white text-foreground transition-colors duration-400">
      <div className="container max-w-6xl mx-auto">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:items-start lg:items-stretch">
          <article className="group relative flex flex-1 cursor-pointer rounded-sm border border-gray-200 p-3 transition-all ease-out translate-y-0 hover:border-foreground/10 hover:bg-background-darker/60 hover:-translate-y-0.5 dark:hover:bg-background-lighter/50 md:flex-col flex-col gap-4">
            <a
              aria-label="From silos to synergy: Strategies for better product and marketing collaboration"
              className="absolute inset-0 z-0"
              href="https://learn.customer.io/product-led-growth/working-together"
            ></a>
            <a
              className="relative z-10 w-full self-start overflow-hidden rounded-sm sm:aspect-[16/10] md:max-w-full aspect-[16/10] max-w-full sm:max-w-full"
              href="https://learn.customer.io/product-led-growth/working-together"
            >
              <Image
                ...
                <div className="flex w-full flex-col gap-1 sm:gap-2">
                  <div className="flex h-5 flex-row items-center justify-between">
                    <a
                      ...
                      href="https://learn.customer.io/product-led-growth"
                    >
                      Product-led growth
                    </a>
                  </div>
                  <a href="https://learn.customer.io/product-led-growth/working-together">
                    <h2 className="text-h6 md:text-h5 lg:text-h4">
                      From silos to synergy: Strategies for better product and
                      marketing collaboration
                    </h2>
                  </a>
                  <div className="mt-2">
                    <p className="text-small sm:text-p text-foreground-muted">
                      Seamless customer journeys stem from product-marketing
                      synergy. Learn strategies from our team for fostering
                  ...
                  <div className="flex flex-nowrap items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <div className="flex flex-row items-center gap-1 text-sm leading-tight">
                        <span className="font-bold">Alexandra Hubley</span>
                      </div>
