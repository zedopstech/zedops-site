...
const CtoContent = {
    ...
    subTitles: [
        ...
        },
        {
            ...
            icon: Clock,
            content: "Expert guidance through setup and initial configuration.",
        },
    ],
    contactOptions: [
        {
            ...
            {CtoContent.content}
                ...
                <div className="mx-auto text-center mb-16">
                    <div
                        ...
                        <div className="flex">
                            <span className="tracking-wide text-xs sm:text-sm lg:text-lg">Early Access Program</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    {CtoContent.subTitles.map((item, index) => (
                        ...
                        >
                            ...
                            <div
                                className="absolute inset-0 bg-gradient-to-br from-secondary/5 to-secondary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                            {/* Decorative circle */}
                            <div
                                className="absolute -right-8 -bottom-8 w-32 h-32 rounded-full bg-secondary/5 group-hover:bg-secondary/10 transition-colors duration-300"></div>

                            {/* Content with relative positioning */}
                            <div className="relative z-10">
                                <div
                                    className="mb-4 inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 text-secondary group-hover:text-secondary transition-colors duration-300 shadow-md">
                ...
                <div
                    className="bg-gradient-to-r from-secondary/10 via-secondary/5 to-primary/10 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-secondary/20">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        {/* Left side - CTA */}
                        <div className="lg:col-span-5 space-y-6">
                            <h3 className="text-2xl font-bold text-gray-900">Ready to transform your construction
                                management?</h3>
                            <p className="text-gray-600">Get early access to our AI-powered platform and receive
                                personalized onboarding support from our team of construction technology experts.</p>
                        ...
                        <div className="lg:col-span-7">
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                {CtoContent.contactOptions.map((option, index) => (
                                    ...
                                    >
                                        <div
                                            className="w-12 h-12 rounded-full bg-secondary/10 text-secondary flex items-center justify-center mb-3 group-hover:bg-secondary group-hover:text-white transition-colors duration-300">
