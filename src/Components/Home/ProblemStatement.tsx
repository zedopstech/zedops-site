      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="mx-auto text-center mb-16">
          ...
          <p className="text-gray-600 text-sm sm:text-lg lg:text-xl max-w-3xl mx-auto font-medium">
            ...
            efficiently. From team collaboration to cost control, ZedOps has you
            covered.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-5">
          {WHY_ZEDOPS.map((item) => (
            <div className="space-y-4 sm:space-y-8 relative" key={item.id}>
              <div className="bg-gradient-to-br from-gray-50 via-gray-50 to-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 group border border-gray-100/50 relative overflow-hidden h-full">
                ...
                <div className="relative z-10 p-2">
                  ...
                  <div
                    className={
                      "mb-2 font-semibold text-gray-700 group-hover:text-secondary transition-colors duration-300"
                    }
                  >
                    <span className="text-gray-500 group-hover:text-gray-600 transition-colors duration-300 relative z-10">
                      {item.sub_title}
                    </span>
                  </div>
        ...
        <div className="mt-16 text-center">
          <p className="mb-6 font-bold text-xl text-secondary">
            🚀 Ready to transform your construction operations and achieve these
            results?
          </p>
