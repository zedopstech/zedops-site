...
export default function FeatureIntegration({FeatureIntegration}: {FeatureIntegration: any}) {
  ...
  return (
    ...
    <div className="container grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6 mx-auto max-w-6xl">
       {FeatureIntegration?.apps.map((app: any, index: number) => (
            ...
            <div className="size-full overflow-hidden rounded p-6 md:p-8 group h-full border border-gray-100 bg-custombg transition-all ease-out translate-y-0 hover:border-gray-200 hover:-translate-y-1">
                ...
                <div className="flex h-full flex-col justify-between gap-8">
                    <div className="flex flex-col gap-4">
                        ...
                        <div>
                            <h3 className="mb-2 text-xl font-semibold leading-tight first-letter:normal-case">Amazon S3</h3>
                            <p className="text-base leading-tight text-foreground-muted group-hover:text-foreground">Streamline data transfer from Customer.io to Amazon S3 storage, including messages, people, metrics, and more.</p>
                        </div>
                    </div>
        ...
        <div className="flex items-center justify-center gap-2">
            ...
            >
                <span className="relative flex min-h-10 flex-col justify-center overflow-hidden">
                    <span className="relative transition-all duration-500 ease-out-fast translate-y-0 group-hover:opacity-0 group-hover:-translate-y-10">See all integrations</span>
                    <span className="absolute opacity-0 transition-all duration-500 ease-out-fast translate-y-10 group-hover:opacity-100 group-hover:-translate-y-0">See all integrations</span>
                </span>
            </a>
        </div>
    </div>
