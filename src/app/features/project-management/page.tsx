              ...
              <ul className="space-y-4">
                <li
                  className={`flex items-center px-6 py-3 hover:bg-gray-200 rounded-lg ${
                    activeSection === "projects" ? "bg-gray-200 font-bold" : ""
                  }`}
                >
                  <FilePlus className="h-6 w-6 text-orange-500" />
                  <a
                    href="#projects"
                    className="block text-lg font-semibold text-gray-700 ml-4"
                  >
                    Projects
                  </a>
                </li>
                <li
                  className={`flex items-center px-6 py-3 hover:bg-gray-200 rounded-lg ${
                    activeSection === "daily-logs" ? "bg-gray-200 font-bold" : ""
                  }`}
                >
                ...
                <li
                  className={`flex items-center px-6 py-3 hover:bg-gray-200 rounded-lg ${
                    activeSection === "scheduling" ? "bg-gray-200 font-bold" : ""
                  }`}
                >
