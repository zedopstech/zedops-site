...
const additionalFeatures = [
  {
    ...
    description:
      "For superintendents, project managers, and even subcontractor managers, it’s paramount to keep logs of what happens on the job site. Have that complete Project Record for years to come.",
  },
  {
    name: "People on Jobsite",
    description:
      "You no longer have to guess – keep it all easily recorded in the Daily Log. This is great for tracking down the source of delays.",
  },
  {
    name: "Material & Equipment used",
    description:
      "Do you know where your inventory is being used and when? If you are recording it in our Daily Log’s then you will.",
  },
];
...
const thirdSectionFeatures = [
  {
    ...
    description:
      "Seamlessly integrate with your existing tools like Slack, Trello, and more to streamline your workflows.",
  },
  {
    name: "Gantt Charts",
    description:
      "Generate and customize reports to suit your specific needs and share insights with your team.",
  },
  {
    name: "Percent Complete Tracking",
    description:
      "Ensure your data is secure with enterprise-grade encryption and regular backups.",
  },
];

export default function Example() {
  const [openFeature, setOpenFeature] = useState<number | null>(null);
  const [openAdditionalFeature, setOpenAdditionalFeature] = useState<
    number | null
  >(null);
          ...
          <div className="grid gap-16 sm:gap-20 lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              ...
              <p className="mt-6 text-lg text-gray-600">
                Organize your projects with customizable workflows and boards.
                Set clear goals and track milestones with interactive Gantt
                charts. Assign tasks, manage resources, and ensure timely
                delivery.
              </p>
              <dl className="mt-10 space-y-8">
                {features.map((feature, index) => (
                  <div key={feature.name} className="relative">
                    ...
                    >
                      <ArrowRight className="inline-block text-indigo-600" />{" "}
                      {feature.name}
                    </dt>
                    <dd
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-16 sm:gap-20 lg:grid-cols-2">
            ...
            <div className="lg:pr-8 lg:pt-4">
              ...
              <p className="mt-6 text-lg text-gray-600">
                Full Daily Logs keep you safe and up to date. Weather, visitors,
                safety, productivity, materials used, and more are all covered
                in your Daily Logs.
              </p>
              <dl className="mt-10 space-y-8">
