import { ArrowUpRight, Calculator, Lightbulb } from "lucide-react";
import { Button } from "@/Components/UI/button";

import Link from "next/link";

const CtoContent = {
  mainTitle: "Excel with Smarter Estimation",
  content:
    " Accurately predict costs, optimize resources, and streamline budgeting to ensure your projects stay on time and within budget.",
  subTitles: [
    {
      title: "Efficient Estimation Starts Here",
      icon: <Calculator className="w-12 h-12" />,
      image: "/cto-estimation.jpg",
      content:
        "Streamline cost analysis, forecast budgets, and enhance project planning with powerful estimation tools.",
    },
    {
      title: "Smart Estimation Made Simple",
      icon: <Lightbulb className="w-12 h-12" />,
      image: "/cto-estimation-1.jpg",
      content:
