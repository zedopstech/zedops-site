...
const BookDemo = () => {
        ...
        () => [
            {
                ...
                description:
                    "Manage all construction projects from a single dashboard with real-time updates and insights.",
            },
            {
                ...
                description:
                    "Our intelligent algorithms optimize resource allocation and predict potential delays before they happen.",
            },
            {
                ...
                description:
                    "Connect field teams, office staff, and stakeholders with integrated communication tools.",
            },
            {
                ...
                description:
                    "Eliminate repetitive tasks and streamline approval processes to save time and reduce errors.",
            },
        ],
        []
    );
    ...
    const handleInputChange = (
        ...
        //     console.warn("Invalid international phone number");
        //   }
        // }
    ...
    useEffect(() => {
        if (formSubmitted) {
            const timer = setTimeout(() => {
                window.open(
                    "https://calendly.com/ajaysharvesh-zedops/30min?primary_color=006f35&back=1",
                    "_blank"
                );
    ...
    const faqs = [
        {
            question:
                "What makes ZedOps different from other construction management software?",
            answer:
                "ZedOps is built specifically for modern construction needs with AI-powered insights, real-time collaboration, and intuitive mobile access. Our platform focuses on simplifying complex workflows while providing powerful analytics to help you make better decisions faster.",
        },
        {
            question: "How long does implementation typically take?",
            answer:
                "Most teams are up and running with ZedOps in less than two weeks. Our streamlined onboarding process includes data migration, team training, and personalized configuration to match your specific workflows.",
        },
        {
            question: "Is ZedOps suitable for small construction businesses?",
            answer:
                "Absolutely! ZedOps scales to fit businesses of all sizes. We offer flexible pricing plans that grow with your needs, making enterprise-grade construction management accessible to smaller teams.",
        },
        {
            question: "Can ZedOps integrate with our existing software tools?",
            answer:
                "Yes, ZedOps offers robust API integration capabilities with popular construction and business software including accounting systems, BIM tools, and project management platforms.",
        },
    ];
            ...
            <div className="relative overflow-hidden  py-16">
              ...
              <span className="relative inline-block">
                ...
                intelligent construction platform
                            ...
                            can transform your project delivery and boost your team&apos;s
                            productivity.
                        </p>
                    </div>

                    <div className="flex flex-wrap justify-center gap-5 mb-8">
                        {["Interactive Demo", "Custom Solutions", "ROI Analysis"].map(
                            (feature, idx) => (
                                <div
                                    key={idx}
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative">
                                                        <Input
                                                            ...
                                                            } text-card-foreground placeholder:text-card-foreground/50 focus:border-accent focus:ring-accent`}
                                                            required
                                                        />
                                                        {emailError && (
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                    {[
                                                        ...
                                                        >
                                                            ...
                                                            <Label
                                                                htmlFor={interest.id}
                                                                className="flex items-center text-sm text-card-foreground cursor-pointer"
                                                            >
    ...
    <div className="bg-white rounded-xl shadow-lg p-12 text-center max-w-2xl mx-auto border border-secondary/20 relative overflow-hidden">
        ...
        <div className="relative z-10">
                    ...
                    {[
                        {
                            ...
                            description:
                                "Our team will reach out to find a time that works for you.",
                        },
                        {
            ...
            <p className="text-gray-600 mb-6">
                In the meantime, check your email for some resources about how ZedOps
                can transform your construction management.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Link href="/resources">
                    <Button
                        variant="outline"
                        className="border-secondary text-white hover:bg-secondary/90 hover:text-white px-6"
                    >
                        Explore Resources
                    </Button>
                </Link>
