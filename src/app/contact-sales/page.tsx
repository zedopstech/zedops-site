      ...
      <main className="flex-grow relative z-10 py-12 bg-gray-50">
        <section className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-xl transform transition-all hover:shadow-2xl hover:border-secondary/30">
              ...
              <div className="mt-12 p-6 bg-gray-50 rounded-lg border border-gray-200">
                <h3 className="text-xl font-bold text-gray-900">Why Choose ZedOps?</h3>
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-xl transform transition-all">
              <h3 className="text-3xl font-extrabold text-gray-900">
                Get in <span className="text-secondary">Touch</span>
              </h3>
              <p className="mt-3 text-gray-600">Fill out the form below and we&apos;ll get back to you as soon as possible.</p>
