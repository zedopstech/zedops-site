...
const ComingSoonContent = {
  ...
  content:
    "ZedOps is on its way to revolutionize how construction projects are managed, from preconstruction to closeout. Stay ahead of the curve with a platform designed to simplify workflows, boost collaboration, and drive efficiency across your projects",
  section: [
    {
      title: "Ready to Use",
      description:
        "Build your projects with modular and pre-designed blocks tailored for your construction need.",
    },
    {
      title: "End-to-End Tools",
      description:
        "From planning to completion, all your project essentials in one place",
    },
    {
      title: "Easy Access",
      description:
        "Intuitive design ensures accessibility for every team member, from site workers to office admins",
    },
  ],
};
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="mt-8 space-y-8 sm:space-x-12 sm:mt-12 sm:flex sm:items-start sm:justify-center sm:space-y-0 md:space-x-20 lg:mt-20">
            <div className="lg:flex lg:justify-between grid items-start">
              {ComingSoonContent.section.map((item, index) => (
              ...
              <div className="sm:p-2 sm:bg-white sm:border-2 sm:border-transparent sm:rounded-full sm:focus-within:border-gray-500 sm:focus-within:ring-1">
                <div className="flex flex-col items-start sm:flex-row sm:justify-center">
                  ...
                  <button
                    ...
                    type="submit"
                    className="inline-flex items-center justify-center w-auto px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-orange-400 border border-transparent rounded-full sm:ml-4 sm:mt-0 sm:w-auto hover:bg-orange-300"
                  >
          ...
          {!enable && (
            <div className="max-w-2xl mx-auto mt-6">
              <div
                className="p-4 mb-4 text-sm text-center bg-green-50"
                role="alert"
              >
